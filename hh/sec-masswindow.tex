...
The effect of reconstructing the 4-body invariant mass with $\Mtilde$ on the signal shape can be seen in Figure \ref{fig:mx}. 
...
\begin{figure*}[h]
  ...
  %The normalizations are such that the uncorrected mass peaks at 1 (same normalization for different reconstructions in each mass point). 
