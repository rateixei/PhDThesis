...
The barrel and endcap crystals are shaped as trapezoidal prisms, with 23 and 22 cm of length, respectively. 
The crystal's front face (facing the interaction point) has an area of approximately $22\times22$ mm$^{2}$ (about $\Delta\eta\times\Delta\phi = 0.0175\times0.0175$) for the barrel and $25\times25$ mm$^{2}$ (about $\Delta\eta\times\Delta\phi = 0.02\times0.02$). 

The ECAL crystals are arranged to provide an off-pointing, pseudo-projective geometry, shown in the left of Figure \ref{fig:ecal_geometry}. 
...
The VFE sends information to the front-end electronics at the sampling rate. 
